...
my $xsdname = "1-butylene_GAFF_box";
...
my ($AAMD_atomtypes, $AAMD_bondtypes, $AAMD_angletypes, $AAMD_dihedraltypes);
...
LMP_AAMD_N($xsddoc);
($AAMD_atomtypes, $AAMD_bondtypes, $AAMD_angletypes, $AAMD_dihedraltypes) = LMP_AAMD_Ntypes($xsddoc);
